...
int main(){
	...
	int maior = lista[0]; //Supondo que o primeiro elemento do vetor é o maior. Não posso por zero aqui pois, se o array for e números negativos a solução vai ser incorreta.
	for (i = 0; i < 5; i++)
	{
		if (maior < lista[i])
		{
